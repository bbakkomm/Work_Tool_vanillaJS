...
export const sticky = {
    init(sticky_pxToVw) {
        ...
        const [scollToVw_pc, scollToVw_mo, scollToVw_fold] = sticky_pxToVw;
        ...
        let stickyMove = function() {
            ...
            const pxToVwTot = _.pxToVw(scollToVw_pc, scollToVw_mo, scollToVw_fold);
            ...
            navArr.forEach((item) => {
                ...
                for (let i = 0; i < ancArr.length; i++) {
                    ...
                    if (scrollTop >= $(target).offset().top + pxToVwTot && scrollTop < $(nextTarget).offset().top + pxToVwTot) {
